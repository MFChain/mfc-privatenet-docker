...
#DOCKER_CMD="docker exec -it mfc-privnet screen -wipe"

echo "Committing docker image as mfc-privnet:latest"
docker commit mfc-privnet mfc-privnet:latest

echo "Next steps:"
echo "- docker tag mfc-privnet:latest mfchain/mfc-privnet:latest"
echo "- docker tag mfc-privnet:latest mfchain/mfc-privnet:<version>"
echo "- docker push mfchain/mfc-privnet:latest mfchain/mfc-privnet:<version>"

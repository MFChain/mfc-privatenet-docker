...
* A wallet with 100,000,000 MFF and 48 GAS (after 1 minute) which you can use with neo-python
* A WIF private key you can use with any client.

Run it like this:

    python3 scripts/claim_mff_and_gas_fixedwallet.py

There are several parameters you can configure with cli args. Take a look at the help:

    python3 scripts/claim_mff_and_gas_fixedwallet.py -h
